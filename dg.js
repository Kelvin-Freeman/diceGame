...
//================ Task 1 ==============================
        ...
        const rollDice = () => {                                                                 // Create a function (rollDice)
            const player = Math.ceil(Math.random() * 6)                                   // Roll Two "dice" one for the player and one for the computer
            const computer = Math.floor(Math.random() * 6) + 1                           // Roll Two "dice" one for the player and one for the computer
            console.log('Player:', player);                                             // Use one variables for the (player) and one for the (computer)
